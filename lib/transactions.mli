(* type transaction
   ...
   val load_transactions : string -> transaction list (** [load_transactions
   filename] outputs the transactions of the user's transaction's file which has
   [filename]. *)
   ...
   val add_transaction : transaction -> transaction list -> transaction list val
   delete_transaction : transaction -> transaction list -> transaction list *)
